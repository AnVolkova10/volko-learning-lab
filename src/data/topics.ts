...
// To add a category, choose a unique ID and a readable accent color.
export const categories: Category[] = [
  { id: "programming", label: "Programming", color: "#7453bf" },
  { id: "english", label: "English", color: "#247d76" },
  { id: "3d", label: "3D", color: "#ac6229" },
  { id: "design", label: "Design", color: "#ac527b" },
];

// Tomorrow's note goes here: add an object with a unique ID and a category ID.
// Code examples are display-only strings, never executable application code.
...
function headingText(props: HeadingProps) {
  return props.title; // The callbacks are never used.
    ...
    sources: [
      ...
      {
        title:
          "DIP — Robert C. Martin: The Dependency Inversion Principle (PDF)",
